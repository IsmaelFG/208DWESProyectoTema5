...
<html lang="en">
    <head>
        ...
        <title>mostrarCodigoCreaDB208DWESProyectoTema5Explotacion</title>
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">CreaDB208DWESProyectoTema5Explotacion</a>
        ...
        <?php
        show_source($filename = "../scriptDB/CreaDB208DWESProyectoTema5Explotacion.php");
        ?>
